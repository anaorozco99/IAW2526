...
AS
SELECT e1.nombre, e2.nombre, e1.distrito
FROM estacion e1, estacion e2
WHERE e1.distrito=e2.distrito;
...
INSERT INTO acceso
SELECT 
(SELECT MAX(numero_acceso) + 1 FROM acceso),
'E', estacion
...
WHERE (modelo, velocidad_maxima) = 
(SELECT modelo, velocidad_maxima FROM tren WHERE codigo = 17) AND codigo <> 17;
